			...
			<div class="col-md-4 appointmnet-left">
				<div class="inner">
					...
					<div class="working-grid1">
						...
						<p>Our representatives will get back to you within 24 hours.</p>
					<div class="clearfix"></div>
					</div>
					<div class="clearfix"></div>
				</div>
			...
			<div class="col-md-4 appointmnet-middle">
				<div class="inner">
					...
					<form action="#" name="row" method="post" class="register">
						...
						<input type="text" name="mobile" id="Mobile_Number" placeholder="Mobile Number" required="">
						<input class="date" id="datepicker" type="text" name="date" value="Appointment date" onfocus="this.value = '';" onblur="if (this.value == '') {this.value = 'Appointment date';}" required="">
						<textarea onfocus="this.value = '';" onblur="if (this.value == '') {this.value = 'Enter Message...';}" name="message" >Enter Message...</textarea>
