...
<div class="container menus" id="home" style="margin-top: 40px">
<div class="row">
	<div class="col-sm-2 text-center navpad1" id="navhome"><a href="index.php" class="white">Home</a></div>
	<div class="col-sm-2 text-center navpad1" id="navabout"><a href="aboutus.php" class="white">About Us</a></div>
	<div class="col-sm-2 text-center navpad1" id="navblog"><a href="index.php#blog" class="white">Blogs</a></div>
	<div class="col-sm-2 text-center navpad1" id="navproduct"><a data-toggle="tab" href="index.php#products" class="white">Products</a></div>
	<div class="col-sm-2 text-center navpad1" id="navcontact"><a href="index.php#contact" class="white">Contact</a></div>
	<div class="col-sm-2 text-center navpad1" id="navtestimonials"><a href="index.php#testimonials" class="white">Testimonials</a></div>

	<div class="col-sm-2 text-center navpad1" id="navtestimonials"><a href="manufacturing.php" class="white">MANUFACTURING</a></div>
	<div class="col-sm-2 text-center navpad1" id="navtestimonials"><a href="franchise.php" class="white">FRANCHISE</a></div>
